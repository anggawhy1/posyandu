    ...
    <div class="overflow-x-auto border rounded-lg shadow">
        <table class="table-auto w-full border-collapse border border-gray-400 text-sm">
            <thead class="bg-gray-700 text-white">
                <tr>
                    <th class="border p-2 text-center align-middle" rowspan="2">No</th>
                    <th class="border p-2 text-center align-middle" rowspan="2">Nama Anak</th>
            ...
            <tbody>
                ...
                <?php foreach ($pemantauan as $balita): ?>
                    ...
                    <tr>
                        ...
                        <td class="border p-2 text-center"><?= esc($balita['nama_anak']) ?></td>
                            ...
                            <?php foreach (['bb', 'tb', 'ntob', 'lila', 'lk', 'vit_a', 'asi'] as $field): ?>
                                <td class="border p-1 text-center">
                                    <input type="text" value="<?= esc($data[$field] ?? '') ?>"
                                        class="editable-cell text-center w-full bg-transparent px-1 py-1 text-xs" style="min-width:60px"
                        ...
                        <td class="border p-2 text-center">
                            <button id="simpan-btn-<?= $balita['id_balita'] ?>" onclick="konfirmasiSimpan(<?= $balita['id_balita'] ?>)" class="bg-blue-500 text-white px-3 py-1 rounded hidden">Simpan</button>
                        </td>
                    </tr>
                    <?php endif; ?>
                <?php endforeach ?>
